...
const AboutMe = () => {
  ...
  return (
    <section
      id="about-me"
      ref={containerRef}
      className="relative container min-h-[90vh] py-24"
    >
      ...
      <div className="flex flex-col lg:flex-row ltr:flex-row rtl:flex-row-reverse items-center gap-12">
        ...
        <div className="w-full lg:w-7/12 about-fade">
          <div className="ltr:text-left rtl:text-right">
            ...
            <p className="mt-6 text-base md:text-lg leading-8 opacity-85">
              {t('description')}
            </p>
